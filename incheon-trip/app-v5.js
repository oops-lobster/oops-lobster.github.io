const PLACES={
 ...
 bakery:{name:"마시안제빵소",lat:37.434,lng:126.41,kind:"activity",naver:"https://map.naver.com/p/search/마시안제빵소",time:"오후 · 낮잠 후 유동",desc:"2안 · 45–60분 · 추석 특별 영업 미확인 · 핀은 대략 위치, 길찾기는 네이버 지도"},
 mieum:{name:"카페 미음",lat:37.431,lng:126.414,kind:"activity",naver:"https://map.naver.com/p/search/카페%20미음",time:"오후 · 낮잠 후 유동",desc:"2안 카페 선택 · 추석 특별 영업 미확인 · 핀은 대략 위치, 길찾기는 네이버 지도"},
...
function showLayer(layer) {
  ...
  document.getElementById("mapNote").textContent=layer === "day2" ? "DAY 2 · 1 장모님집 → 2·3 부추꽃요양원" : layer === "backup" ? "1안 인스파이어 · 2안 마시안제빵소 / 미음 · 새 핀은 대략 위치" : "일정과 같은 번호 · 선은 방문 순서 · 새 핀은 대략 위치";
  fitCurrentLayer();
}
...
function selectPlan(plan, cafe=activeCafe) {
 ...
 document.getElementById("activityNote").textContent=plan==="inspire"?"영종도 이동 후 60–90분 관람. 14:10 한복 퍼레이드는 시간이 맞을 때만. 26일 아레나 공연 혼잡 가능. 주차 조건 현장 확인.":"영종도 이동 후 45–60분 휴식. 올해 추석 특별 영업·아기의자는 매장 확인. 비가 그치면 해변 짧게 산책.";
 document.getElementById("planSummary").textContent="점심·닭강정 → 영종도 → "+PLACES[pid].name+" → 장보기 → 아빛스테이";
...
const BBQ=["고기 — 삼겹/목살/소고기 등","나윤이용 간하지 않은 고기/식사 별도","상추 · 깻잎 · 마늘 · 고추","버섯 · 양파 등 구울 채소","쌈장 · 소금 · 후추","김치/반찬","밥 또는 즉석밥","나윤이용 김/밥/과일 등 저녁 백업","술 · 탄산/음료 · 생수","얼음","야식용 회를 살 경우 회 · 초장 · 간장 · 와사비","LPG 가스그릴 이용 — 우천 BBQ 가능","객실 안 고기 조리 금지","키친타월 · 호일 · 랩 · 지퍼백 필요 여부","쓰레기 분리배출 방식 확인"];
