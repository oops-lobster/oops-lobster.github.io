...
const PACK=["기저귀 넉넉히 + 여분 2–3개","물티슈 · 휴대티슈 · 기저귀갈이 매트","기저귀 크림 · 기저귀 봉투/비닐","여벌옷 2세트 이상 · 잠옷 · 양말","면회 전 버거킹 햄버거 약 4개 픽업","턱받이 · 아기 수저/포크 · 빨대컵","물 · 이동용 간식 · 과일/퓨레","아기 식사 백업 — 즉석밥·김·평소 먹는 반찬","유모차 · 레인커버","아기띠(필요 시) · 얇은 담요","수면 애착템 · 취침 루틴 용품","체온계 · 평소 쓰는 상비약","선크림 · 모자","수영복 · 방수기저귀 · 아쿠아슈즈","부모 여벌옷 · 세면도구","충전기 · 보조배터리 · 차량 충전선","우산/우비 · 얇은 겉옷","신분증/지갑 · 면회 관련 필요물품","숙소 예약정보/체크인 연락처 캡처"];
const BBQ=["집에서 · 양고기 프렌치랙(구매 완료) · 소시지","나윤이용 간하지 않은 고기/식사 별도","구울 채소 · 새송이버섯 · 양파 · 통마늘","선택 · 아스파라거스 또는 꽈리고추","양념 · 와사비 · 허브솔트 · 고기용 소금 · 머스타드","김치 · 선택: 명이나물/양파절임","햇반 · 라면","나윤이 저녁 · 밥 · 고기 · 포켓미역국","집에서 · 소주 · 맥주","보냉가방 · 아이스팩","회타운 회 포장 · 소스 포함 여부 확인","BBQ 사전예약 여부 확인 · LPG 2만원","객실 내 고기·해산물 조리 및 개인 화구 금지","키친타월 · 호일 · 랩 · 지퍼백 필요 여부","쓰레기 분리배출 방식 확인","마트 · 삼겹살 또는 목살(선택)","마트 · 생수 · 음료 · 선택: 파인애플"];
